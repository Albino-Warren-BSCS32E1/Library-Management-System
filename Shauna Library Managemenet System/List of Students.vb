...
Public Class List_of_Students
    ...
    Private Sub List_of_Students_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim connectionString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=A:\New folder\Library-Management-System-master\Shauna Library Management System.accdb"

        ' Verify the file path
        If Not System.IO.File.Exists("A:\New folder\Library-Management-System-master\Shauna Library Management System.accdb") Then
    ...
    Private Sub btnStudentDelete_Click(sender As Object, e As EventArgs) Handles btnStudentDelete.Click
        If MessageBox.Show("Do you want to delete the selected student?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
